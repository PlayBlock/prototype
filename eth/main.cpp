...
//	double blockFees = 15.0;
	...
	clientDefaultMode.add_options()
		...
		("p2p-unit-test", po::value<string>()->value_name("<name>"), "Specified the P2PUnitTest name.\n")
		("p2p-sub-test", po::value<string>()->value_name("<name>"), "Specified the P2PSubTest name.\n")
