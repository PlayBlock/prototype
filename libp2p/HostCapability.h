...
public:
	...
	std::vector<std::pair<std::shared_ptr<SessionFace>, std::shared_ptr<PeerSortObject>>> peerSessions() const;
	std::vector<std::pair<std::shared_ptr<SessionFace>, std::shared_ptr<PeerSortObject>>> peerSessions(u256 const& _version) const; 
protected:
