...
namespace dev {
	namespace test {
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/currency.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string currencyHex = toHex(wasmBytes);
		...
		BOOST_AUTO_TEST_CASE(ctCodeSize)
		{
			...
			filename = dev::test::getFolder(__FILE__) + "/WAVMTest/currency_2.wasm";
			wasmBytes = loadFile(filename.c_str());
			std::string currency_2Hex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/infiniteLoop.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string infiniteLoopHex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/infiniteLoop2.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string infiniteLoop2Hex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/overflow.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string overflowHex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/overflow2.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string overflow2Hex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/assert.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string assertHex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/throw.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string throwHex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/overflow3.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string overflow3Hex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/cast.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string castHex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/accessDestroy.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string accessDestroyHex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/newDelete_2.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string newDelete_2Hex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/unknowInstruction.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string unknowInstructionHex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/memoryRef.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string memoryRefHex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/lackApply.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string lackApplyHex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/gas.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string gasHex = toHex(wasmBytes);
		...
		{
			string filename = dev::test::getFolder(__FILE__) + "/WAVMTest/initGas_1.wasm";
			std::string wasmBytes = loadFile(filename.c_str());
			std::string initGas_1Hex = toHex(wasmBytes);

			filename = dev::test::getFolder(__FILE__) + "/WAVMTest/initGas_2.wasm";
			wasmBytes = loadFile(filename.c_str());
			std::string initGas_2Hex = toHex(wasmBytes);

			filename = dev::test::getFolder(__FILE__) + "/WAVMTest/initGas_3.wasm";
			wasmBytes = loadFile(filename.c_str());
			std::string initGas_3Hex = toHex(wasmBytes);
